...
object P005_V2 extends App { // Using tail recursion: forall is very slow
...
object Primes {
  ...
  def getList(max: Int): List[Int] = {
    ...
    val lstb = new collection.mutable.ListBuffer[Int]
...
//  val t = System.nanoTime
//  println(P003.lpf(600851475143L, 2))
//  println((System.nanoTime.toDouble - t)/1e6)
//}
